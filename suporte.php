...
<section class="flex flex-col gap-8">
    <div class="sm:w-2/3 mx-auto p-2">
        ...
        <button onclick="toggleText1()" id="button1"
            class="mt-3 rounded-sm px-5 py-2 bg-red-500 text-white duration-300 hover:bg-red-700">Ver Mais</button>
    <a href="contato.php" class="hover:text-red-500 hover:underline text-white ml-3">Ir para pagina de Contato</a>
    </div>
    ...
    <div class="sm:w-2/3 mx-auto p-2">
        ...
        <button onclick="toggleText2()" id="button2"
            class="mt-3 px-5 py-2 rounded-sm bg-red-500 text-white duration-300 hover:bg-red-700">Ver Mais</button>
        <a href="contato.php" class="hover:text-red-500 hover:underline text-white ml-3">Ir para pagina de Contato</a>
    </div>
